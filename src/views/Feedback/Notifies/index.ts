import LinkedQueue from '../../../models/LinkedList/LinkedQueue';
import { ILinkedQueue } from '../../../models/LinkedList/types';
...
export default class NotifyList {
	private queue: ILinkedQueue<NotificationObject> =
		new LinkedQueue<NotificationObject>(10);
